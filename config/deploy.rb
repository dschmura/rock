  ...
  set :application,     "rock"
  set :repo_url,        "git@github.com:dschmura/rock.git"
  set :user,            'deployer'
  ...
  set :deploy_to,       "/home/#{fetch(:user)}/apps/rock"
  set :puma_bind,       "unix://#{shared_path}/tmp/sockets/rock-puma.sock"
  ...
  namespace :deploy do
    ...
    #       execute("ln -nfs /home/deployer/apps/rock/current/config/nginx.conf /etc/nginx/sites-enabled/rock && rm /etc/nginx/sites-enabled/default")
    #     end
    #   end
    # end
